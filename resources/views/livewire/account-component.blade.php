            ...
            <div class="container">
                <div class="tab tab-vertical row gutter-lg">
                    <ul class="nav nav-tabs mb-6" role="tablist">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('shop') }}" class="nav-link">Wishlist</a>
                        </li>
                        <li class="nav-item">
                                ...
                                <tbody>
                                    @foreach ($orders as $order)
                                        <tr>
                                            ...
                                            <td class="text-center order-date">{{ $order->order_date }}</td>
                                            <td class="text-center order-status">{{ $order->status }}</td>
                                            <td class="text-center order-total">${{ $order->order_total }} for {{ $order->orderline->count() }} items</td>
                                            <td class="text-center order-action"><a href="#" class="btn btn-outline btn-default btn-block btn-sm btn-rounded">View</a></td>
                                        </tr>
                                    @endforeach
                                    {{-- <tr>
                                        ...
                                        <td class="order-action"><a href="#" class="btn btn-outline btn-default btn-block btn-sm btn-rounded">View</a></td>
                                    </tr> --}}
                                </tbody>
                            </table>
                        ...
                        <div class="tab-pane" id="account-details">
                            ...
                            <form class="form account-details-form" action="#" method="post">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="firstname" name="firstname" placeholder="{{ Auth::user()->name }}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="lastname" name="lastname" placeholder="{{ Auth::user()->name }}"
                                                class="form-control form-control-md">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" id="display-name" name="display_name" placeholder="{{ Auth::user()->name }}"
                                ...
                                <div class="form-group mb-6">
                                    ...
                                    <input type="email" id="email_1" name="email_1"
                                        class="form-control form-control-md" placeholder="{{ Auth::user()->email }}">
                                </div>
